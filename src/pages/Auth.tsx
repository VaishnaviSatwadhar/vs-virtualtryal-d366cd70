            ...
            <>
              ...
              {(view === 'login' || view === 'signup') && (
                <>
                  ...
                  {/* Magic Link Button */}
                  <Button type="button" variant="outline" size="lg" className="w-full" onClick={() => setView('magic-link')}>
                  ...
                  <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-card text-muted-foreground">Or use email & password</span>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleEmailAuth} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" variant="outline" size="lg" disabled={loading}>
                      {loading ? 'Please wait...' : view === 'login' ? 'Sign In with Email' : 'Sign Up with Email'}
                    </Button>
                  </form>

...
const products: Product[] = [
  ...
  // Budget-Friendly Collection (₹50 - ₹200)
  {
    id: "49",
  ...
  },
  {
    ...
    category: 'jewelry',
    image: silverBracelet,
    colors: ["#DC2626", "#4ECDC4", "#FFD700", "#9B59B6"],
    isNew: true,
  },
  // Super Budget Collection (₹1 - ₹10)
  {
    id: "61",
    name: "Hair Pin Set",
    brand: "TinyStyle",
